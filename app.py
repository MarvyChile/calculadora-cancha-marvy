...
# Medidas claras fuera del campo
ax.text(largo_total / 2, ancho_total + 5, f"LARGO TOTAL: {largo_total} m", ha='center', fontsize=11, weight='bold')
ax.text(largo_total + 6, ancho_total / 2, f"ANCHO TOTAL: {ancho_total} m", va='center', rotation=270, fontsize=11, weight='bold')
ax.text(largo_total / 2, -7, f"LARGO ÚTIL: {largo_util} m", ha='center', fontsize=10)
ax.text(-7, ancho_total / 2, f"ANCHO ÚTIL: {ancho_util} m", va='center', rotation=90, fontsize=10)
